...
public class RegistradorAlojamiento extends javax.swing.JInternalFrame {
    ...
    private ManejadorReservacion mr = null;
    private double monto = 0;

    public RegistradorAlojamiento(BaseDatos DB, Usuario usr) {
        this.DB = DB;
        this.usuario = usr;
        mr = new ManejadorReservacion(DB);
    ...
    private void buttonRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRegistrarActionPerformed
        mr.setAlojamiento(reserSelec, monto, this);
        buttonRegistrar.setEnabled(false);
        actualizarLista(1);
    ...
    private void actualizarLista(int opcion) {
        ...
        if (opcion == 1) {
            ...
            if(mr.getReservacionesByDateEntradaMayor(jDateChooserInicio.getDate(), 0) != null){
                listaReserObser.addAll(mr.getReservacionesByDateEntradaMayor(jDateChooserInicio.getDate(), 0));
            }
        } else if (opcion == 3) {
